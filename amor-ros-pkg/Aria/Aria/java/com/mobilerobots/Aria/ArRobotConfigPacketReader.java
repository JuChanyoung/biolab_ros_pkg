...
public class ArRobotConfigPacketReader {
  ...
  public SWIGTYPE_p_std__string buildString() {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArRobotConfigPacketReader_buildString(swigCPtr, this), true);
  }

  public SWIGTYPE_p_std__string buildStringMovement() {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArRobotConfigPacketReader_buildStringMovement(swigCPtr, this), true);
  }
