...
public class ArMapSimple extends ArMapInterface {
  ...
  public void addMapChangedCB(ArFunctor functor, ArListPos.Pos position) {
    AriaJavaJNI.ArMapSimple_addMapChangedCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }
  ...
  public void addPreMapChangedCB(ArFunctor functor, ArListPos.Pos position) {
    AriaJavaJNI.ArMapSimple_addPreMapChangedCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }
  ...
  public SWIGTYPE_p_std__string createRealFileName(String fileName) {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArMapSimple_createRealFileName(swigCPtr, this, fileName), true);
  }
