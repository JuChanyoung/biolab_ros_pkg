...
public class ArPose {
  ...
  public void getPose(SWIGTYPE_p_double x, SWIGTYPE_p_double y, SWIGTYPE_p_double th) {
    AriaJavaJNI.ArPose_getPose__SWIG_0(swigCPtr, this, SWIGTYPE_p_double.getCPtr(x), SWIGTYPE_p_double.getCPtr(y), SWIGTYPE_p_double.getCPtr(th));
  }

  public void getPose(SWIGTYPE_p_double x, SWIGTYPE_p_double y) {
    AriaJavaJNI.ArPose_getPose__SWIG_1(swigCPtr, this, SWIGTYPE_p_double.getCPtr(x), SWIGTYPE_p_double.getCPtr(y));
  }
