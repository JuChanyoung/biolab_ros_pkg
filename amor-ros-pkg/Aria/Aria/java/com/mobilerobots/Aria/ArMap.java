...
public class ArMap extends ArMapInterface {
  ...
  public void addMapChangedCB(ArFunctor functor, ArListPos.Pos position) {
    if (getClass() == ArMap.class) AriaJavaJNI.ArMap_addMapChangedCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue()); else AriaJavaJNI.ArMap_addMapChangedCBSwigExplicitArMap__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }
  ...
  public void addPreMapChangedCB(ArFunctor functor, ArListPos.Pos position) {
    if (getClass() == ArMap.class) AriaJavaJNI.ArMap_addPreMapChangedCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue()); else AriaJavaJNI.ArMap_addPreMapChangedCBSwigExplicitArMap__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }
  ...
  public SWIGTYPE_p_std__string createRealFileName(String fileName) {
    return new SWIGTYPE_p_std__string((getClass() == ArMap.class) ? AriaJavaJNI.ArMap_createRealFileName(swigCPtr, this, fileName) : AriaJavaJNI.ArMap_createRealFileNameSwigExplicitArMap(swigCPtr, this, fileName), true);
  }
