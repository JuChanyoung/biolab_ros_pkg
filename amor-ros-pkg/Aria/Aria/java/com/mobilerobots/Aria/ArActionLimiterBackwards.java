...
public class ArActionLimiterBackwards extends ArAction {
  ...
  public ArActionLimiterBackwards(String name, double stopDistance, double slowDistance, double maxBackwardsSpeed, double widthRatio) {
    this(AriaJavaJNI.new_ArActionLimiterBackwards__SWIG_0(name, stopDistance, slowDistance, maxBackwardsSpeed, widthRatio), true);
  }

  public ArActionLimiterBackwards(String name, double stopDistance, double slowDistance, double maxBackwardsSpeed) {
    this(AriaJavaJNI.new_ArActionLimiterBackwards__SWIG_1(name, stopDistance, slowDistance, maxBackwardsSpeed), true);
  }

  public ArActionLimiterBackwards(String name, double stopDistance, double slowDistance) {
    this(AriaJavaJNI.new_ArActionLimiterBackwards__SWIG_2(name, stopDistance, slowDistance), true);
  }

  public ArActionLimiterBackwards(String name, double stopDistance) {
    this(AriaJavaJNI.new_ArActionLimiterBackwards__SWIG_3(name, stopDistance), true);
  }

  public ArActionLimiterBackwards(String name) {
    this(AriaJavaJNI.new_ArActionLimiterBackwards__SWIG_4(name), true);
  }

  public ArActionLimiterBackwards() {
    this(AriaJavaJNI.new_ArActionLimiterBackwards__SWIG_5(), true);
  }
