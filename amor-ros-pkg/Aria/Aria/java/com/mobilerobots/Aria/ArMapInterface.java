...
public class ArMapInterface extends ArMapInfoInterface {
  ...
  public static SWIGTYPE_p_std__string createRealFileName(String baseDirectory, String fileName, boolean isIgnoreCase) {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArMapInterface_createRealFileName__SWIG_0(baseDirectory, fileName, isIgnoreCase), true);
  }
  ...
  public void addMapChangedCB(ArFunctor functor, ArListPos.Pos position) {
    AriaJavaJNI.ArMapInterface_addMapChangedCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }
  ...
  public void addPreMapChangedCB(ArFunctor functor, ArListPos.Pos position) {
    AriaJavaJNI.ArMapInterface_addPreMapChangedCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }
  ...
  public SWIGTYPE_p_std__string createRealFileName(String fileName) {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArMapInterface_createRealFileName__SWIG_1(swigCPtr, this, fileName), true);
  }
