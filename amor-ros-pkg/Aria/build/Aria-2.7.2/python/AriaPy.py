...
class ArPose:
    ...
    def getPose(self, *args):
        ...
        """
        return _AriaPy.ArPose_getPose(self, *args)
...
class ArTime:
    ...
    def log(self):
        """log(self)"""
        return _AriaPy.ArTime_log(self)
...
class ArJoyHandler:
    ...
    def getDoubles(self, *args):
        ...
        """
        return _AriaPy.ArJoyHandler_getDoubles(self, *args)
    ...
    def getAdjusted(self, *args):
        """
        getAdjusted(self, int x, int y, int z = None)
        getAdjusted(self, int x, int y)
        """
        return _AriaPy.ArJoyHandler_getAdjusted(self, *args)
    ...
    def getUnfiltered(self, *args):
        """
        getUnfiltered(self, int x, int y, int z = None)
        getUnfiltered(self, int x, int y)
        """
        return _AriaPy.ArJoyHandler_getUnfiltered(self, *args)
    ...
    def getSpeeds(self, *args):
        """getSpeeds(self, int x, int y, int z)"""
        return _AriaPy.ArJoyHandler_getSpeeds(self, *args)
...
class ArLMS1XXPacket(ArBasePacket):
    """Proxy of C++ ArLMS1XXPacket class"""
    __swig_setmethods__ = {}
    for _s in [ArBasePacket]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLMS1XXPacket, name, value)
    __swig_getmethods__ = {}
    for _s in [ArBasePacket]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ArLMS1XXPacket, name)
    __repr__ = _swig_repr
    def __init__(self): 
        """__init__(self) -> ArLMS1XXPacket"""
        this = _AriaPy.new_ArLMS1XXPacket()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _AriaPy.delete_ArLMS1XXPacket
    __del__ = lambda self : None;
    def getCommandType(self):
        """getCommandType(self) -> char"""
        return _AriaPy.ArLMS1XXPacket_getCommandType(self)

    def getCommandName(self):
        """getCommandName(self) -> char"""
        return _AriaPy.ArLMS1XXPacket_getCommandName(self)

    def finalizePacket(self):
        """finalizePacket(self)"""
        return _AriaPy.ArLMS1XXPacket_finalizePacket(self)

    def resetRead(self):
        """resetRead(self)"""
        return _AriaPy.ArLMS1XXPacket_resetRead(self)

    def getTimeReceived(self):
        """getTimeReceived(self) -> ArTime"""
        return _AriaPy.ArLMS1XXPacket_getTimeReceived(self)

    def setTimeReceived(self, *args):
        """setTimeReceived(self, ArTime timeReceived)"""
        return _AriaPy.ArLMS1XXPacket_setTimeReceived(self, *args)

    def duplicatePacket(self, *args):
        """duplicatePacket(self, ArLMS1XXPacket packet)"""
        return _AriaPy.ArLMS1XXPacket_duplicatePacket(self, *args)

    def empty(self):
        """empty(self)"""
        return _AriaPy.ArLMS1XXPacket_empty(self)

    def byteToBuf(self, *args):
        """byteToBuf(self, Byte val)"""
        return _AriaPy.ArLMS1XXPacket_byteToBuf(self, *args)

    def byte2ToBuf(self, *args):
        """byte2ToBuf(self, Byte2 val)"""
        return _AriaPy.ArLMS1XXPacket_byte2ToBuf(self, *args)

    def byte4ToBuf(self, *args):
        """byte4ToBuf(self, Byte4 val)"""
        return _AriaPy.ArLMS1XXPacket_byte4ToBuf(self, *args)

    def uByteToBuf(self, *args):
        """uByteToBuf(self, UByte val)"""
        return _AriaPy.ArLMS1XXPacket_uByteToBuf(self, *args)

    def uByte2ToBuf(self, *args):
        """uByte2ToBuf(self, UByte2 val)"""
        return _AriaPy.ArLMS1XXPacket_uByte2ToBuf(self, *args)

    def uByte4ToBuf(self, *args):
        """uByte4ToBuf(self, UByte4 val)"""
        return _AriaPy.ArLMS1XXPacket_uByte4ToBuf(self, *args)

    def strToBuf(self, *args):
        """strToBuf(self, char str)"""
        return _AriaPy.ArLMS1XXPacket_strToBuf(self, *args)

    def bufToByte(self):
        """bufToByte(self) -> Byte"""
        return _AriaPy.ArLMS1XXPacket_bufToByte(self)

    def bufToByte2(self):
        """bufToByte2(self) -> Byte2"""
        return _AriaPy.ArLMS1XXPacket_bufToByte2(self)

    def bufToByte4(self):
        """bufToByte4(self) -> Byte4"""
        return _AriaPy.ArLMS1XXPacket_bufToByte4(self)

    def bufToUByte(self):
        """bufToUByte(self) -> UByte"""
        return _AriaPy.ArLMS1XXPacket_bufToUByte(self)

    def bufToUByte2(self):
        """bufToUByte2(self) -> UByte2"""
        return _AriaPy.ArLMS1XXPacket_bufToUByte2(self)

    def bufToUByte4(self):
        """bufToUByte4(self) -> UByte4"""
        return _AriaPy.ArLMS1XXPacket_bufToUByte4(self)

    def bufToStr(self, *args):
        """bufToStr(self, char buf, int len)"""
        return _AriaPy.ArLMS1XXPacket_bufToStr(self, *args)

    def rawCharToBuf(self, *args):
        """rawCharToBuf(self, unsigned char c)"""
        return _AriaPy.ArLMS1XXPacket_rawCharToBuf(self, *args)

ArLMS1XXPacket_swigregister = _AriaPy.ArLMS1XXPacket_swigregister
ArLMS1XXPacket_swigregister(ArLMS1XXPacket)

class ArLMS1XXPacketReceiver:
    """Proxy of C++ ArLMS1XXPacketReceiver class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLMS1XXPacketReceiver, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ArLMS1XXPacketReceiver, name)
    __repr__ = _swig_repr
    def __init__(self): 
        """__init__(self) -> ArLMS1XXPacketReceiver"""
        this = _AriaPy.new_ArLMS1XXPacketReceiver()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _AriaPy.delete_ArLMS1XXPacketReceiver
    __del__ = lambda self : None;
    def receivePacket(self, msWait = 0, shortcut = False):
        """
        receivePacket(self, unsigned int msWait = 0, bool shortcut = False) -> ArLMS1XXPacket
        receivePacket(self, unsigned int msWait = 0) -> ArLMS1XXPacket
        receivePacket(self) -> ArLMS1XXPacket
        """
        return _AriaPy.ArLMS1XXPacketReceiver_receivePacket(self, msWait, shortcut)

    def setDeviceConnection(self, *args):
        """setDeviceConnection(self, ArDeviceConnection conn)"""
        return _AriaPy.ArLMS1XXPacketReceiver_setDeviceConnection(self, *args)

    def getDeviceConnection(self):
        """getDeviceConnection(self) -> ArDeviceConnection"""
        return _AriaPy.ArLMS1XXPacketReceiver_getDeviceConnection(self)

ArLMS1XXPacketReceiver_swigregister = _AriaPy.ArLMS1XXPacketReceiver_swigregister
ArLMS1XXPacketReceiver_swigregister(ArLMS1XXPacketReceiver)

class ArLMS1XX(ArLaser):
    """Proxy of C++ ArLMS1XX class"""
    __swig_setmethods__ = {}
    for _s in [ArLaser]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLMS1XX, name, value)
    __swig_getmethods__ = {}
    for _s in [ArLaser]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ArLMS1XX, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(self, int laserNumber, char name = "lms1XX") -> ArLMS1XX
        __init__(self, int laserNumber) -> ArLMS1XX
        """
        this = _AriaPy.new_ArLMS1XX(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _AriaPy.delete_ArLMS1XX
    __del__ = lambda self : None;
    def blockingConnect(self):
        """blockingConnect(self) -> bool"""
        return _AriaPy.ArLMS1XX_blockingConnect(self)

    def asyncConnect(self):
        """asyncConnect(self) -> bool"""
        return _AriaPy.ArLMS1XX_asyncConnect(self)

    def disconnect(self):
        """disconnect(self) -> bool"""
        return _AriaPy.ArLMS1XX_disconnect(self)

    def isConnected(self):
        """isConnected(self) -> bool"""
        return _AriaPy.ArLMS1XX_isConnected(self)

    def isTryingToConnect(self):
        """isTryingToConnect(self) -> bool"""
        return _AriaPy.ArLMS1XX_isTryingToConnect(self)

    def log(self):
        """log(self)"""
        return _AriaPy.ArLMS1XX_log(self)

ArLMS1XX_swigregister = _AriaPy.ArLMS1XX_swigregister
ArLMS1XX_swigregister(ArLMS1XX)
...
class ArRobotJoyHandler:
    ...
    def getDoubles(self, *args):
        ...
        return _AriaPy.ArRobotJoyHandler_getDoubles(self, *args)
