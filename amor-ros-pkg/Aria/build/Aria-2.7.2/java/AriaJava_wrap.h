...
public:
    void swig_connect_director(JNIEnv *jenv, jobject jself, jclass jcls, bool swig_mem_own, bool weak_global);
    SwigDirector_ArMap(JNIEnv *jenv, char const *baseDirectory = "./", bool addToGlobalConfig = true, char const *configSection = "Files", char const *configParam = "Map", char const *configDesc = "Map of the environment that the robot uses for navigation", bool ignoreEmptyFileName = true, ArPriority::Priority priority = ArPriority::IMPORTANT, char const *tempDirectory = NULL);
...
public:
    bool swig_overrides(int n) {
      return (n < 136 ? swig_override[n] : false);
    }
protected:
    bool swig_override[136];
};
