...
public class ArUtil {
  ...
  public static int sizeFile(SWIGTYPE_p_std__string fileName) {
    return AriaJavaJNI.ArUtil_sizeFile__SWIG_1(SWIGTYPE_p_std__string.getCPtr(fileName));
  }
  ...
  public static int strcmp(SWIGTYPE_p_std__string str, SWIGTYPE_p_std__string str2) {
    return AriaJavaJNI.ArUtil_strcmp__SWIG_0(SWIGTYPE_p_std__string.getCPtr(str), SWIGTYPE_p_std__string.getCPtr(str2));
  }

  public static int strcmp(SWIGTYPE_p_std__string str, String str2) {
    return AriaJavaJNI.ArUtil_strcmp__SWIG_1(SWIGTYPE_p_std__string.getCPtr(str), str2);
  }

  public static int strcmp(String str, SWIGTYPE_p_std__string str2) {
    return AriaJavaJNI.ArUtil_strcmp__SWIG_2(str, SWIGTYPE_p_std__string.getCPtr(str2));
  }
  ...
  public static int strcasecmp(SWIGTYPE_p_std__string str, SWIGTYPE_p_std__string str2) {
    return AriaJavaJNI.ArUtil_strcasecmp__SWIG_0(SWIGTYPE_p_std__string.getCPtr(str), SWIGTYPE_p_std__string.getCPtr(str2));
  }

  public static int strcasecmp(SWIGTYPE_p_std__string str, String str2) {
    return AriaJavaJNI.ArUtil_strcasecmp__SWIG_1(SWIGTYPE_p_std__string.getCPtr(str), str2);
  }

  public static int strcasecmp(String str, SWIGTYPE_p_std__string str2) {
    return AriaJavaJNI.ArUtil_strcasecmp__SWIG_2(str, SWIGTYPE_p_std__string.getCPtr(str2));
  }
  ...
  public static int strcasequotecmp(SWIGTYPE_p_std__string str1, SWIGTYPE_p_std__string str2) {
    return AriaJavaJNI.ArUtil_strcasequotecmp(SWIGTYPE_p_std__string.getCPtr(str1), SWIGTYPE_p_std__string.getCPtr(str2));
  }
