...
public class ArSoundsQueue extends ArASyncTask {
  ...
  public SWIGTYPE_p_std__string nextItemByType(ArSoundsQueue.ItemType type) {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArSoundsQueue_nextItemByType(swigCPtr, this, type.swigValue()), true);
  }

  public SWIGTYPE_p_std__string nextItemByPriority(int priority) {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArSoundsQueue_nextItemByPriority(swigCPtr, this, priority), true);
  }

  public SWIGTYPE_p_std__string nextItemByTypeAndPriority(ArSoundsQueue.ItemType type, int priority) {
    return new SWIGTYPE_p_std__string(AriaJavaJNI.ArSoundsQueue_nextItemByTypeAndPriority(swigCPtr, this, type.swigValue(), priority), true);
  }
