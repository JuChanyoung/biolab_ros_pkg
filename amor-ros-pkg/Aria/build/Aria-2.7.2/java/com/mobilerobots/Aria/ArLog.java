...
public class ArLog {
  ...
  public static void aramInit(String prefix, ArLog.LogLevel defaultLevel, double defaultSize) {
    AriaJavaJNI.ArLog_aramInit__SWIG_0(prefix, defaultLevel.swigValue(), defaultSize);
  }

  public static void aramInit(String prefix, ArLog.LogLevel defaultLevel) {
    AriaJavaJNI.ArLog_aramInit__SWIG_1(prefix, defaultLevel.swigValue());
  }

  public static void aramInit(String prefix) {
    AriaJavaJNI.ArLog_aramInit__SWIG_2(prefix);
  }
