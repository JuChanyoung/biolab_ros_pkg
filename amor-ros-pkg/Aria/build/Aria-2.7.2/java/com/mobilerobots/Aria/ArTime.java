...
public class ArTime {
  ...
  public void addMSec(int ms) {
    AriaJavaJNI.ArTime_addMSec(swigCPtr, this, ms);
  }

  public void setSec(SWIGTYPE_p_time_t sec) {
    AriaJavaJNI.ArTime_setSec(swigCPtr, this, SWIGTYPE_p_time_t.getCPtr(sec));
  }

  public void setMSec(SWIGTYPE_p_time_t msec) {
    AriaJavaJNI.ArTime_setMSec(swigCPtr, this, SWIGTYPE_p_time_t.getCPtr(msec));
  }

  public SWIGTYPE_p_time_t getSec() {
    return new SWIGTYPE_p_time_t(AriaJavaJNI.ArTime_getSec(swigCPtr, this), true);
  }

  public SWIGTYPE_p_time_t getMSec() {
    return new SWIGTYPE_p_time_t(AriaJavaJNI.ArTime_getMSec(swigCPtr, this), true);
  }

  public void log() {
    AriaJavaJNI.ArTime_log(swigCPtr, this);
  }
