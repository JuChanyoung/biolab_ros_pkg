...
public class ArMath {
  ...
  public static void pointRotate(SWIGTYPE_p_double x, SWIGTYPE_p_double y, double th) {
    AriaJavaJNI.ArMath_pointRotate(SWIGTYPE_p_double.getCPtr(x), SWIGTYPE_p_double.getCPtr(y), th);
  }
